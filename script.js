...
let PrixTotalAvecPourcentage3 = PrixTotalSansPourcentage - PrixTotalAvecPourcentage2;
...
if(getPourcentage == 0 || null ){
  ...
  let affichageConclusion = document.getElementById('messageDeValidation').innerHTML = 
  `<h1>Résultat</h1>
